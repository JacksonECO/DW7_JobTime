...
const ProjectTaskSchema = CollectionSchema(
  name: 'ProjectTask',
  schema:
      '{"name":"ProjectTask","idName":"id","properties":[{"name":"createdAt","type":"Long"},{"name":"duration","type":"Long"},{"name":"name","type":"String"}],"indexes":[],"links":[]}',
  idName: 'id',
  propertyIds: {'createdAt': 0, 'duration': 1, 'name': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {},
...
extension ProjectTaskQueryWhereSortBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByCreatedAt() {
    return addSortByInternal('createdAt', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> sortByCreatedAtDesc() {
...
extension ProjectTaskQueryWhereSortThenBy
  ...
  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByCreatedAt() {
    return addSortByInternal('createdAt', Sort.asc);
  }

  QueryBuilder<ProjectTask, ProjectTask, QAfterSortBy> thenByCreatedAtDesc() {
    return addSortByInternal('createdAt', Sort.desc);
  }
...
extension ProjectTaskQueryWhereDistinct
  ...
  QueryBuilder<ProjectTask, ProjectTask, QDistinct> distinctByCreatedAt() {
...
extension ProjectTaskQueryProperty
  ...
  QueryBuilder<ProjectTask, DateTime, QQueryOperations> createdAtProperty() {
